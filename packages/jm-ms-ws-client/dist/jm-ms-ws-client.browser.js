(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jm-event'), require('jm-logger'), require('jm-ms-core')) :
  typeof define === 'function' && define.amd ? define(['exports', 'jm-event', 'jm-logger', 'jm-ms-core'], factory) :
  (global = global || self, factory(global['jm-ms-ws-client'] = {}, global.jmEvent, global.jmLogger, global.jmMsCore));
}(this, (function (exports, jmEvent, jmLogger, jmMsCore) { 'use strict';

  jmEvent = jmEvent && Object.prototype.hasOwnProperty.call(jmEvent, 'default') ? jmEvent['default'] : jmEvent;
  jmLogger = jmLogger && Object.prototype.hasOwnProperty.call(jmLogger, 'default') ? jmLogger['default'] : jmLogger;
  jmMsCore = jmMsCore && Object.prototype.hasOwnProperty.call(jmMsCore, 'default') ? jmMsCore['default'] : jmMsCore;
  ...
  var WebSocket$1 = /*#__PURE__*/function () {
    function WebSocket() {
      var _this = this;
  ...
  WebSocket$1.MaxReconnectAttempts = MaxReconnectAttempts;
  WebSocket$1.ReconnectTimeout = ReconnectTimeout;
  WebSocket$1.PingFailedCode = PingFailedCode;
  var ws$1 = WebSocket$1;
  var $$1 = {
    HeartBeat: heartbeat,
    WebSocket: ws$1
  };
  ...
  var MAXID = 999999;
  var errNetwork$1 = error.err(Err$2.FA_NETWORK);
            ...
            return new Promise(function (resolve, reject) {
              ...
              setTimeout(function () {
                if (cbs[id]) {
                  ...
                  var _e = error.err(Err$2.FA_TIMEOUT);
